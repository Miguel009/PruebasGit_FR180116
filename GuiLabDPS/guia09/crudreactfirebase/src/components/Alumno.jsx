            ...
            <tbody>
              {Alumnos.map((Alumno) => (
                <tr key={Alumno.id}>
                  ...
                  <td>{Alumno.edad}</td>
                  <td>
                    <button className="btn btn-primary buton" onClick={() => setCurrentId(Alumno.id)}>Editar</button>
                    &nbsp;
                    &nbsp;
                    <button className="btn btn-danger buton" onClick={() => onDeleteAlumno(Alumno.id)}>Eliminar</button>
                  </td>
                </tr>
              ))}
            </tbody>
